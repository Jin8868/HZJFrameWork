...
public class Reporter : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        currentView = currentView = ReportView.Logs;
    ...
    void initializeStyle()
    {
        ...
        evenLogStyle.fixedHeight = size.y * 2.0f;
        ...
        //logButtonStyle.wordWrap = true;
        logButtonStyle.fontSize = (int)(size.y * 1.5f);
        ...
        selectedLogStyle.fixedHeight = size.y * 2.0f;
        ...
        //selectedLogStyle.wordWrap = true;
        selectedLogFontStyle.fontSize = (int)(size.y * 1.5f);
        ...
        stackLabelStyle.fontSize = (int)(size.y / 2) + 12;
    ...
    void drawToolBar()
    {
        ...
        if (GUILayout.Button(logContent, nonStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsText, nonStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            showLog = !showLog;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(warningContent, nonStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            showWarning = !showWarning;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsWarningText, nonStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            showWarning = !showWarning;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(errorContent, nonStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
        if (GUILayout.Button(logsErrorText, nonStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            showError = !showError;
            calculateCurrentLog();
        }
        ...
        if (GUILayout.Button(closeContent, barStyle, GUILayout.Width(size.x * 1.5f), GUILayout.Height(size.y * 2)))
        {
            show = false;
            PlayerPrefs.SetInt("Reporter_show", 0);
            mReportRoot.mIsShowLogFrame = false;
    ...
    public void SetReportRoot(ReporterRoot reporterRoot)
    {
        mReportRoot = reporterRoot;
    }
    ...
    void DrawLogs()
    {
        ...
        for (int i = startIndex; (startIndex + index) < endIndex; i++)
        {
            ...
            if (log == selectedLog)
            {
                GUILayout.Box(content, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2.0f));
            ...
            {
                if (GUILayout.Button(content, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y * 2.0f)))
                {
    ...
    public void OnGUIDraw()
    {
        ...
        screenRect.y = 0.0f;
        screenRect.width = Screen.width;
        screenRect.height = Screen.height - 20.0f;

        getDownPos();

        logsRect.x = 0f;
        logsRect.y = size.y * 2f + 20.0f;
        ...
        stackRect.y = Screen.height * 0.75f + 20.0f;
        stackRect.width = Screen.width;
        stackRect.height = Screen.height * 0.25f - size.y - 20.0f;
    ...
    void Update()
    {
        ...
        //    doShow();
        //}
        //bool isShow = PlayerPrefs.GetInt("Reporter_show") == 1;
        //if (!show && isShow)
        //{
        //    show = true;
        //    doShow();
